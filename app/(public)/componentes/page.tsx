...
import { CardProyecto, CardProyectoDetalle, FilaProyecto } from '@/components/tarjetas/proyecto'
import { CardBeneficio, CardMetrica, CardOportunidad } from '@/components/tarjetas/bloques'
...
export default async function CatalogoPage() {
  const [sectores, servicios, proyectos] = await Promise.all([
    getSectores(),
    getServicios(),
    ...
    <div className="contenedor py-16">
      <header className="mb-14">
        ...
        <p className="text-p1 mt-4 max-w-2xl text-blanco/60">
          Todos los componentes del sitio, con datos reales de la API. Achicá la ventana para
          ver el comportamiento responsive: el corte va en 768px.
        </p>
      ...
      <div className="space-y-20">
        ...
        <Grupo id="botones" titulo="Botones">
          <Muestra nombre="Variantes" usoEn="la punteada es el CTA principal del sitio">
          ...
          <Muestra nombre="Flechas de carrusel" usoEn="Novedades, proyectos destacados">
        ...
        <Grupo id="etiquetas" titulo="Etiquetas">
          <Muestra nombre="Chip de sector" usoEn="se pinta según el nombre que devuelve la API">
        ...
        <Grupo id="formulario" titulo="Formulario">
          <Muestra nombre="Campos" usoEn="pantalla de Contacto">
            <div className="grid gap-5 md:max-w-lg">
              <Campo id="c-nombre" etiqueta="Nombre completo" placeholder="Ej: Paula Calgaro" />
              <Campo
                id="c-email"
        ...
        <Grupo id="proyectos" titulo="Proyectos">
          {proyectos.items.length ? (
            <>
              <Muestra nombre="Tarjeta de proyecto" usoEn="grilla de Proyectos, destacados">
              ...
              <Muestra nombre="Tarjeta extendida" usoEn="proyecto destacado a ancho completo">
                <CardProyectoDetalle proyecto={proyectos.items[0]} />
              </Muestra>
              <Muestra nombre="Fila de proyecto" usoEn="tabla Últimos proyectos">
                <div>
                  {proyectos.items.map((proyecto) => (
        ...
        <Grupo id="bloques" titulo="Bloques">
          ...
          <Muestra nombre="Métrica" usoEn="bloque Nuestra red en Home">
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <CardMetrica rotulo="Cooperativas" valor="+30" acento="amarillo" />
        ...
        <Grupo id="secciones" titulo="Secciones">
          ...
          <Muestra nombre="Banda de conversión" usoEn="cierre de casi todas las páginas">
            <BandaCta
